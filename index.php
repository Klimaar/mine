...
<head>
    ...
    <title>Miner Web Panel | DARK MONEY</title>
...
<div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        <a href="index.php" class="brand-link">
            <img src="assets/img/dm.jpg" alt="DARK MONEY" class="brand-image">
            <span class="brand-text font-weight-light">Miner Web Panel</span>
        </a>
    ...
    <footer class="main-footer">
        <strong>Copyright &copy;<?php echo date("Y"); ?> DM Miner Web Panel.</strong>
